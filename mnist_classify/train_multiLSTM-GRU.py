"""
1.static_rnn + multi LSTM-GRU
2.dynamic_rnn + multi LSTM-GRU
...
# 分别建立GRUCell和LSTMCell
gru_cell = tf.contrib.rnn.GRUCell(n_hidden*2)
lstm_cell = tf.contrib.rnn.LSTMCell(n_hidden)

# 将GRUCell和LSTMCell合在一起实例化MultiRNNCell对象得到mcell
mcell = tf.contrib.rnn.MultiRNNCell([lstm_cell, gru_cell])
