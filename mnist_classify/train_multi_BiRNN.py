"""
1.multi bidirectional static rnn
2.multi bidirectional dynamic rnn
...
# 1.static stack bidirectional rnn
# outputs, _, _ = tf.contrib.rnn.stack_bidirectional_rnn(stacked_rnn, stacked_bw_rnn, x1, dtype = tf.float32)

# 2.dynamic stack bidirectional rnn
outputs, _, _ = tf.contrib.rnn.stack_bidirectional_dynamic_rnn(stacked_rnn, stacked_bw_rnn, X, dtype = tf.float32)
